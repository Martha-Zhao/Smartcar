...
def mac (para):
    if para[0] < 20 and para[1] - para[0] >= 15:
       return (1)
        ...
        return (0)
    elif para[3] == para[5] == 0 and para[7:14] == [255,255,255,0,0,0,255]:
        return (0) # New_Add
        ...
        return (7)
    elif para[3] == 255 and para[5:9] == [0,255,0,0] and para[11] == 0 and para[13] == 0:
        return (6)  #New_Add
        ...
        return (2)
    elif para[3:12] == [0,0,0,0,0,0,0,0,0] and (para[14] == 255 or para[13] == 255):
        return (2)
    elif para[2:8] == [255,0,0,0,0,0] and para[9:12] == [0,0,255]:
        return (2)  #####New_Add
    #elif para[2:12] == [0,0,255,0,0,0,255,0,0,255] and para[13:] == [255,255]:
        #return (2)
    elif para[2:8] == [255,0,255,255,0,0] and para[9:14] == [0,0,255,0,0]:
        return (2)
...
while(True):
    ...
    find_piece = 0
    for blob in b:
        if blob[4] > 800 and blob[0] > 25 and blob[0] < 130 and blob[1] > 5 and blob[1] < 72 and blob[2] < 100 and blob[3] < 60 and find_piece != 1:
        ...
        if a == 65:
            if find_piece == 1:
                if error_piece_y < -3:
                    ...
                    uart.writechar(error_piece_x + 100)
                    print("right")
                elif error_piece_x > 2 and error_piece_y  < -18:
                    uart.writechar(72)
                    uart.writechar(error_piece_y + 100)
                    print("backward")
                elif error_piece_x > 2 and error_piece_y  > 18:
