...
% end
pic_sub0 = pic_tem( loc(2,1) : loc(2,2)+8 , loc(1,1)+5 : loc(1,2) );
pic_sub1 = pic_tem( loc(2,1) : loc(2,2)+8 , loc(2,1)+5 : loc(2,2) );
pic_sub2 = pic_tem( loc(1,1) : loc(1,2)+8 , loc(6,1)+5 : loc(6,2) );
pic_sub3 = pic_tem( loc(1,1) : loc(1,2)+8 , loc(8,1)+5 : loc(8,2) );
pic_sub4 = pic_tem( loc(2,1) : loc(2,2)+8 , loc(3,1)+5 : loc(3,2) );
pic_sub5 = pic_tem( loc(2,1) : loc(2,2)+8 , loc(8,1)+5 : loc(8,2) );
pic_sub6 = pic_tem( loc(2,1) : loc(2,2)+8 , loc(4,1)+5 : loc(4,2) );
pic_sub7 = pic_tem( loc(2,1) : loc(2,2)+8 , loc(6,1)+5 : loc(6,2) );
